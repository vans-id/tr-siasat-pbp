...
<head>
  ...
  <title>Siasat - Sistem Informasi dan Administrasi Universitas Kristen Satya Wacana</title>
      ...
      <div class="container" data-aos="fade-up" >
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Sejarah Universitas Kristen Satya Wacana</h3>
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="5187" data-purecounter-duration="1" class="purecounter"></span>
            <p>Mahasiswa</p>
          </div>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Pengembangan Minat dan Bakat</h4>
                    <p>Terdiri dari Vokal Grup Lentera Kasih, Teater (Teras dan Kronis) hingga Basket, Volly, dan Bela Diri</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-cube-alt"></i>
                    <h4>Layanan Kesejahteraan</h4>
                    <p>Layanan mahasiswa mencakup bidang keuangan, kesehatan, dan pemondokan</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Sejak awal tahun 1970-an UKSW telah membentuk Pusat Bimbingan konseling bagi mahasiswa</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
