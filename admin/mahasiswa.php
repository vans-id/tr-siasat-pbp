          ...
          <div class="card mb-4">
            <div class="card-body pb-0">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="tambah_mhs.php" class="btn btn-outline-primary">Tambah</a>
              </div>
              <?php
                ...
                foreach ($data as $key => $val) {
                  $data_table .= '
                    <tr>
                      ...
                      <td>' . $val['contact'] . '</td>
                      <td>
                        <a class="btn btn-outline-info" href="edit_mhs.php?nim=' . $val['nim'] . '">Edit</a>
                        <a class="btn btn-outline-danger" href="mahasiswa.php?hapus=' . $val['nim'] . '">Hapus</a>
                      </td>
                    </tr>
                ';
                }
