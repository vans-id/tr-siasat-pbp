  ...
  <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item"><span>Kelas</span></li>
    ...
    <div class="body flex-grow-1 px-3">
      ...
      if (isset($_POST['add_class'])) {
        ...
        $newClass['lecturer_id'] = isset($_POST['lecturer_id']) ? $_POST['lecturer_id'] : "";
        ...
        if ($newClass['subject_id'] == "" || $newClass['lecturer_id'] == "" || $newClass['name'] == "" || $newClass['room'] == "" || $newClass['size'] == "" || $newClass['day'] == "" || $newClass['start_time'] == "" || $newClass['end_time'] == "") {
          ...
          <div class="card mb-5">
            <div class="card-body pb-0">
              ...
              <form method="POST">
                ...
                <div class="mb-3">
                  <label for="subject_id" class="form-label">Kode Matakuliah</label>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="lecturer_id" placeholder="67977" required>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="name" placeholder="X" required>
                </div>

                <div class="mb-3">
                  <label class="form-label">Ruangan</label>
                  <input type="text" class="form-control" name="room" placeholder="FTI464" required>
                </div>

                <div class="mb-3">
                  <label class="form-label">Kursi</label>
                  <input type="number" class="form-control" name="size" placeholder="40" required>
                </div>
