          ...
          <div class="card mb-4">
            <div class="card-body pb-0">
              ...
              if (!isset($_SESSION['user'])) {
                ...
                if (sizeof($data) > 0) {
                  echo '
                          <form method="POST" action="edit_mhs.php?nim=' . $nim . '">
                            <table class="table table-borderless">
                              ...
                              <tr>
                                  <td colspan="1"></td>
                                  <td nowrap><button class="btn btn-info text-white" type="submit" name="edit">Edit</button>&nbsp;&nbsp;<a href="mahasiswa.php" class="btn btn-outline-secondary ml-4">Kembali</a></td>
                              </tr>
                            </table>
                          </form>
                      ';
