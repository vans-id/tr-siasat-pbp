    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="active" href="beasiswa.php">Beasiswa</a></li>
        ...
        <div class="col-md-4 mt-4">
          <div class="card">
              ...
              <div class="card-body">
                  ...
                  <br>
                  <a href="#"><center><button class="btn btn-primary btn-sm" style="margin-top: 10px; width: 40%">More</button></center></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 mt-4">
